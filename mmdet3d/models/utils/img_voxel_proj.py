...
class ImgVoxelProj(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(ImgVoxelProj, self).__init__()
        self.conv_layer = []
        ...
        self.depth_proj = ImgDepthSample(embed_dims=embed_dims,
    ...
    def feat_encoding(self, voxel_space, **kwargs):
        ...
        for _idx, layer in enumerate(self.conv_layer):
            if self.use_for_distill:
                ...
                # layer[0].in_channels = 256
                # print(f'=={layer[0]}==={layer}=={voxel_space.shape}==')
...
class ImgDepthSample(BaseModule):
    ...
    def __init__(self,
                 ...
                 device='cuda',
                 fp16_enabled=False):
        super(ImgDepthSample, self).__init__()
        self.device = device
...
def feature_sampling(mlvl_feats, reference_voxel, pc_range, img_metas, img_depth=None, num_sweeps=1, num_cam=6, fp16_enabled=False):
    ...
    reference_voxel_cam[..., 0] /= img_metas[0]['img_shape'][1]
    reference_voxel_cam[..., 1] /= img_metas[0]['img_shape'][0]
