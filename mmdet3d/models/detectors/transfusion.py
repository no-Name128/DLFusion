...
class TransFusionDetector(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        """
        if self.kwargs['pts_bbox_head']['type'] == 'TransFusionHead':
    ...
    def simple_test_pts(self, x, x_img, img_metas, rescale=False):
        """Test function of point cloud branch.  for TransFusion-L Head"""
        if self.kwargs['pts_bbox_head']['type'] == 'TransFusionHead':
        ...
        elif self.kwargs['pts_bbox_head']['type'] == 'CenterHead':
